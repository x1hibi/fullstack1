...
<body>
    ...
    <!--header-->
        ...
        <img src="img/logo.png" class="img1 dlogo">
            <p class="eslogan">Onlyzxcz the best for you</p>
  ...
  <div class="row">
    <div class="col-sm icon1">
      <div class="dborder shadow pop">
          <a href="movie.php" id="movie1" onclick="selectedMovie(this.id)"><img src="/img/mov1.jpg" alt="Responsive image" class="responsive"></a>
        </div>
    </div>
    <div class="col-sm icon2">
            <div class="dborder shadow pop">
                <a href="movie.php" id="movie2" onclick="selectedMovie(this.id)">
        <img src="/img/mov2.jpg" alt="Responsive image" class="responsive"></a>
        </div>
    </div>
